...
echo "Setgid files:"
echo "============="
#this command finds the file in right type and with right pwermissions
find / -type f -executable -perm -4000 -ls 2>/dev/null | sort -k 3
echo ""

echo "10 largest files:"
echo "================"
#here find command is used to find the 10 largest files sorted by name, owner, and size in MB
