...
#downloading a tar file of pictures and then saving it to the picture directory if it isnt already there
...
test -f ~/Pictures/pics.zip && unzip -d ~/Pictures -q -o ~/Pictures/pics.zip && rm ~/Pictures/pics.zip

#unpack tar file if it is there and then delete the local copy
